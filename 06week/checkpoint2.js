...
// Create a new branch called checkpoint2.
// Complete the code.
// Create a new file in 06week called checkpoint2.
// Copy/paste & Complete the code below.
// Submit a pull request against your gh-pages branch.
// Rubric:
...
const weatherStates = weather.map( item => item.weather_state_name).filter( (item, index, array) => array.indexOf(item) === index);
